...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="Enable Joern CPG analysis for enhanced data flow insights (experimental)",
)
@click.option(
    "--verbose",
    "-v",
...
def generate_command(
    ...
    Analyzes current repository and generates documentation using LLM-powered
    ...
    \b
    # With Joern CPG analysis for enhanced data flow insights
